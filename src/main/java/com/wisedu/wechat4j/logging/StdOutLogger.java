...
public class StdOutLogger extends Logger {
    ...
    @Override public void debug(String message, String message2) {
        if (DEBUG) {
    ...
    @Override public void info(String message, String message2) {
    ...
    @Override public void warn(String message, String message2) {
    ...
    @Override public void error(String message, Throwable th) {
